...
public interface MerchantService {
    void approveMerchant(UUID merchantId, String language) throws DtoValidateException, URISyntaxException, IOException, InterruptedException, CustomException.TalerException;
